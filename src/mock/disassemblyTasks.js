...
const seedTasks = [
  ...
  taskSeed({
    ...
    placement: 'todo',
    serialLocked: false,
    createdAt: `${formatTaskDate()} 08:10:00`,
  }),
  taskSeed({
    id: 'pt-003',
    orderCategory: '生产工单',
    ...
    placement: 'todo',
    serialLocked: true,
    createdAt: `${formatTaskDate()} 08:20:00`,
  }),
  taskSeed({
    id: 'pt-004',
    orderCategory: '生产工单',
  ...
  taskSeed({
    ...
    placement: 'todo',
    serialLocked: false,
    createdAt: `${formatTaskDate()} 09:15:00`,
  }),
  taskSeed({
    id: 'pt-006',
    orderCategory: '生产工单',
  ...
  // —— 工时工资演示：三种报工×计薪（今日待报工） ——
  taskSeed({
    id: 'pt-wage-1',
    orderCategory: '生产工单',
    workOrderId: 'wo-lh-01',
    workOrderCode: 'WO-LH-01',
    workOrderName: '工时演示-批量计件计件',
    taskNo: 'TLH20260601001',
    processName: '机加工',
    processSeq: 1,
    productName: '工时演示-批量计件计件',
    itemCode: 'LH-MAT-01',
    specModel: '演示物料A',
    salesOrderNo: '1-20260606-101',
    barcodeType: '一批一码',
    processRoute: '工时演示路线-计件',
    executor: '张三',
    groupName: '加工小组',
    expectedQty: 20,
    taskStatus: '待报工',
  ...
  taskSeed({
    id: 'pt-wage-2',
    orderCategory: '生产工单',
    workOrderId: 'wo-lh-02',
    workOrderCode: 'WO-LH-02',
    workOrderName: '工时演示-批量计件计时',
    taskNo: 'TLH20260601002',
    processName: '领料',
    processSeq: 1,
    productName: '工时演示-批量计件计时',
    itemCode: 'LH-MAT-02',
    specModel: '演示物料B',
    salesOrderNo: '1-20260606-102',
    barcodeType: '一批一码',
    processRoute: '工时演示路线-计时',
    executor: '张三',
    groupName: '加工小组',
    expectedQty: 30,
    taskStatus: '执行中',
    placement: 'todo',
    serialLocked: false,
    createdAt: `${formatTaskDate()} 07:15:00`,
  }),
  taskSeed({
    id: 'pt-wage-3',
    orderCategory: '生产工单',
    workOrderId: 'wo-lh-03',
    workOrderCode: 'WO-LH-03',
    workOrderName: '工时演示-时长报工计时',
    taskNo: 'TLH20260601003',
    processName: '调试',
    processSeq: 1,
    productName: '工时演示-时长报工计时',
    itemCode: 'LH-MAT-03',
    specModel: '演示物料C',
    salesOrderNo: '1-20260606-103',
    barcodeType: '一批一码',
    processRoute: '工时演示路线-时长',
    executor: '张三',
    groupName: '加工小组',
    expectedQty: 1,
    taskStatus: '待报工',
  ...
  taskSeed({
    id: 'pt-wage-4',
    orderCategory: '生产工单',
    workOrderId: 'wo-lh-04',
    workOrderCode: 'WO-LH-04',
    workOrderName: '电机轴套生产工单',
    taskNo: 'TLH20260601004',
    processName: '粗车',
    processSeq: 1,
    productName: '电机轴套',
    itemCode: 'CP2510001',
    specModel: 'Φ80×120',
    salesOrderNo: '1-20260606-104',
    barcodeType: '一批一码',
    processRoute: '机加标准路线',
    executor: '张三',
    groupName: '机加小组',
  ...
  taskSeed({
    id: 'pt-wage-5',
    orderCategory: '生产工单',
    workOrderId: 'wo-lh-05',
    workOrderCode: 'WO-LH-05',
    workOrderName: '离心泵总成生产工单',
    taskNo: 'TLH20260601005',
    processName: '轴承装配',
    processSeq: 2,
    productName: '离心泵总成',
    itemCode: 'CP2510002',
    specModel: 'ISG65-160',
    salesOrderNo: '1-20260606-105',
    barcodeType: '一批一码',
    processRoute: '装配标准路线',
    executor: '张三',
    groupName: '总装小组',
    ...
    placement: 'todo',
    serialLocked: false,
    createdAt: `${formatTaskDate()} 08:05:00`,
  }),
  taskSeed({
    id: 'pt-wage-6',
    orderCategory: '生产工单',
    workOrderId: 'wo-lh-06',
    workOrderCode: 'WO-LH-06',
    workOrderName: '立式多级泵生产工单',
    taskNo: 'TLH20260601006',
    processName: '入库',
    processSeq: 4,
    productName: '立式多级泵',
    itemCode: 'CP2510003',
    specModel: 'CDL4-40',
    salesOrderNo: '1-20260606-106',
    barcodeType: '一批一码',
    processRoute: '装配标准路线',
    executor: '张三',
    groupName: '装配小组',
    ...
    placement: 'todo',
    serialLocked: false,
    createdAt: `${formatTaskDate()} 08:25:00`,
  }),
  taskSeed({
    id: 'pt-wage-7',
    orderCategory: '生产工单',
    workOrderId: 'wo-lh-07',
    workOrderCode: 'WO-LH-07',
    workOrderName: '立式多级泵生产工单',
    taskNo: 'TLH20260601007',
    processName: '预装',
    processSeq: 2,
    productName: '立式多级泵',
    itemCode: 'CP2510003',
    ...
    reportedGoodQty: 3,
    reportedDefectQty: 0,
    createdAt: `${formatTaskDate()} 08:35:00`,
  }),
  // —— 多人执行 · 待领取（工序报工） ——
  taskSeed({
    id: 'pt-claim-1',
  ...
  taskSeed({
    id: 'pt-collab-1',
    orderCategory: '生产工单',
    workOrderId: 'wo-collab-1',
    workOrderCode: 'WO-20260813-007',
    workOrderName: '潜水泵生产工单',
    taskNo: 'T20260813071',
    processName: '试验',
    processSeq: 7,
    productName: '潜水泵',
    itemCode: '21.01.02.03.005',
    specModel: 'QDX3-20-0.55',
    material: '铸铁',
    drawingNo: '20260813-007',
    barcodeType: '一批一码',
    processRoute: '泵装配试验路线',
    executor: '',
    executors: ['张三', '李四', '赵六'],
    groupName: '加工小组',
    resourceType: '工人小组',
  ...
  taskSeed({
    id: 'pt-collab-2',
    orderCategory: '生产工单',
    workOrderId: 'wo-collab-2',
    workOrderCode: 'WO-20260820-012',
    workOrderName: '离心泵调试工单',
    taskNo: 'T20260820012',
    processName: '调试',
    processSeq: 4,
    productName: '离心泵',
    itemCode: 'CP-LX-2024-08',
  ...
  taskSeed({
    id: 'pt-collab-3',
    orderCategory: '生产工单',
    workOrderId: 'wo-collab-3',
    workOrderCode: 'WO-20260820-015',
    workOrderName: '电机出厂检验工单',
    taskNo: 'T20260820015',
    processName: '检验',
    processSeq: 5,
    productName: '三相异步电机',
  ...
  taskSeed({
    id: 'pt-collab-4',
    orderCategory: '生产工单',
    workOrderId: 'wo-collab-4',
    workOrderCode: 'WO-20260820-018',
    workOrderName: '上导轴承座热处理工单',
    taskNo: 'T20260820018',
    processName: '热处理',
    processSeq: 2,
    productName: '上导轴承座',
    ...
    placement: 'todo',
    serialLocked: false,
    createdAt: `${formatTaskDate()} 09:20:00`,
  }),
  // 工单5 — 深井泵拆解待开始
  taskSeed({
    id: 'dt-007',
